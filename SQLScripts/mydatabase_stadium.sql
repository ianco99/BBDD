...
CREATE TABLE `stadium` (
  ...
  UNIQUE KEY `idstadium_UNIQUE` (`id_stadium`)
...
INSERT INTO `stadium` VALUES (1,'Monumental'),(2,'mashiro'),(3,'Metlife'),(4,'Ciclon'),(5,'Cilindro');
...
-- Dump completed on 2024-07-10  0:28:16
